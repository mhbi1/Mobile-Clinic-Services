...
{
	public partial class ChatScreenViewController : UIViewController
	{
		...
		public ChatScreenViewController(IntPtr handle)
			: base (handle)
		{
		...
		void SetUpTableView()
		{
			tableView = new UITableView
			{
				...
				BackgroundColor = UIColor.FromRGB(112, 171, 254)	                                             
			};
			...
			var pinTop = NSLayoutConstraint.Create(tableView, NSLayoutAttribute.Top, NSLayoutRelation.Equal, TopLayoutGuide, NSLayoutAttribute.Bottom, 1f, 59f);
